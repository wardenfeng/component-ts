module me.feng3d {
    ...
    export class ComponentTest {
        ...
        init() {
            ...
            comA.addEventListener(ComponentEvent.BE_ADDED_COMPONENT, this.onBeAdded, this);
            comA.addEventListener(ComponentEvent.BE_REMOVED_COMPONENT, this.onBeRemoved, this);

            container.addComponent(comA);

            assert(container.numComponents == 1);
            assert(container.getComponentsByName(comA.componentName).length == 1);
            ...
            comA.removeEventListener(ComponentEvent.BE_ADDED_COMPONENT, this.onBeAdded, this);
            comA.removeEventListener(ComponentEvent.BE_REMOVED_COMPONENT, this.onBeRemoved, this);
            ...
            var comInterface: ComponentInterface = container.getOrCreateComponentByClass(ComponentInterface);
            ...
            container.removeEventListener(ComponentEvent.BE_REMOVED_COMPONENT, this.onRemoved, this);
        }
        ...
        onAdded(e: ComponentEvent) {
            console.log(e.target.componentName, "onAdded", e.data);
        }
        onRemoved(e: ComponentEvent) {
            console.log(e.target.componentName, "onRemoved", e.data);
        }
        onBeAdded(e: ComponentEvent) {
            console.log(e.target.componentName, "onBeAdded", e.data);
        }
        onBeRemoved(e: ComponentEvent) {
            console.log(e.target.componentName, "onBeRemoved", e.data);
        }
    }
    ...
    class ComponentCustom extends Component {
        constructor() {
            super();
            this.componentName = "ComponentCustom";
        }
    }
